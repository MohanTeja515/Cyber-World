...
export const signup = (full_name, username, email, password, re_password) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
    ...
    const body = JSON.stringify({ full_name, username, email, password, re_password });
